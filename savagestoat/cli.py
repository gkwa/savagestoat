...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--min-pack-size",
        type=int,
        default=packs.DEFAULT_MIN_PACK,
        metavar="N",
        help=f"minimum files in a directory to qualify as a pack (default: {packs.DEFAULT_MIN_PACK})",
    )
    parser.add_argument(
        "--max-pack-size",
        type=int,
        default=packs.DEFAULT_MAX_PACK,
        metavar="N",
        help=f"maximum files in a directory to qualify as a pack (default: {packs.DEFAULT_MAX_PACK})",
    )
    parser.add_argument(
        "--no-clean",
        action="store_true",
...
def main() -> None:
    ...
    collection = packs.build_collection(files, args.min_pack_size, args.max_pack_size)
    ...
    timestamps.randomize_timestamps(pathlib.Path(_STAGING), args.min_pack_size, args.max_pack_size)
